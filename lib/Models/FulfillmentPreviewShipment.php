...
class FulfillmentPreviewShipment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'earliest_ship_date' => '\Swagger\Client\Models\Timestamp',
'latest_ship_date' => '\Swagger\Client\Models\Timestamp',
'earliest_arrival_date' => '\Swagger\Client\Models\Timestamp',
'latest_arrival_date' => '\Swagger\Client\Models\Timestamp',
'fulfillment_preview_items' => '\Swagger\Client\Models\FulfillmentPreviewItemList',    ];
...
'fulfillment_preview_items' => 'getFulfillmentPreviewItems',    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['earliest_ship_date']) {
            $invalidProperties[] = "'earliest_ship_date' can't be null";
        }
        if (null === $this->container['latest_ship_date']) {
            $invalidProperties[] = "'latest_ship_date' can't be null";
        }
        if (null === $this->container['earliest_arrival_date']) {
            $invalidProperties[] = "'earliest_arrival_date' can't be null";
        }
        if (null === $this->container['latest_arrival_date']) {
     ...
     *
     * @param \Swagger\Client\Models\Timestamp $earliest_ship_date earliest_ship_date
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Models\Timestamp $latest_ship_date latest_ship_date
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Models\Timestamp $earliest_arrival_date earliest_arrival_date
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Models\Timestamp $latest_arrival_date latest_arrival_date
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Models\FulfillmentPreviewItemList
     */
     ...
     *
     * @param \Swagger\Client\Models\FulfillmentPreviewItemList $fulfillment_preview_items fulfillment_preview_items
     *
     * @return $this
     */
